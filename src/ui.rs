...
use self::dialogs::{
    render_add_remote_machine_overlay, render_confirm_close_overlay,
...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        workspace_display_group_state, workspace_drop_indicator_row, workspace_list_entries,
...
pub fn render_with_runtime_registry(
    ...
    match app.mode {
        ...
        Mode::AddRemoteMachine => render_add_remote_machine_overlay(app, frame, frame.area()),
