...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::MachineImport(_) => "machine.import",
        ...
        Method::WorkspaceStopParent(_) => "workspace.stop_parent",
        ...
        Method::WorkerRunSubmit(_) => "worker.run.submit",
        Method::WorkerRunGet(_) => "worker.run.get",
        Method::WorkerRunCancel(_) => "worker.run.cancel",
        Method::WorkerRunTimeout(_) => "worker.run.timeout",
        Method::WorkerRunResult(_) => "worker.run.result",
